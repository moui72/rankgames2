...
@click="prev" @keyup.left="prev" @keyup.right="next">
      <a :href="page <= 1 ? false : '#' + id" 
:class="{active: page > 1}">
...
aria-hidden />
    ...
    <div class="col-10 px-3">
      <b-row class="text-center">
        <b-col v-for="p in pages" 
:key="p" class="my-1 page-wrap">
          <a
            :href="'#' + id"
...
@click="next" @keyup.left="prev" @keyup.right="next">
      <a :href="page >= pages ? false : '#' + id" 
